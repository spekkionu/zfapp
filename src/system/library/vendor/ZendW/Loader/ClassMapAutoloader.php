 ...
 */
class ZendW_Loader_ClassMapAutoloader implements ZendW_Loader_SplAutoloader
{
    /**
     ...
     * @return ZendW_Loader_ClassMapAutoloader
     */
    ...
    public function registerAutoloadMap($map)
    {
        ...
        if (!is_array($map)) {
            ...
            throw new ZendW_Loader_Exception_InvalidArgumentException('Map file provided does not return a map');
        }
    ...
    public function registerAutoloadMaps($locations)
    {
        if (!is_array($locations) && !($locations instanceof Traversable)) {
            require_once dirname(__FILE__) . '/Exception/InvalidArgumentException.php';
            throw new ZendW_Loader_Exception_InvalidArgumentException('Map list must be an array or implement Traversable');
        }
     ...
     * @return ZendW_Loader_ClassMapAutoloader|mixed
     * @throws ZendW_Loader_Exception_InvalidArgumentException for nonexistent locations
     */
    protected function loadMapFromFile($location)
    {
        if (!file_exists($location)) {
            require_once dirname(__FILE__) . '/Exception/InvalidArgumentException.php';
            throw new ZendW_Loader_Exception_InvalidArgumentException('Map file provided does not exist');
        }
