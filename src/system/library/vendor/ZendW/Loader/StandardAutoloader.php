 ...
 */
class ZendW_Loader_StandardAutoloader implements ZendW_Loader_SplAutoloader
{
    const NS_SEPARATOR     = '\\';
    ...
    {
        $this->registerPrefix('ZendW', dirname(dirname(__FILE__)));
     ...
     * @return ZendW_Loader_StandardAutoloader
     */
    public function setOptions($options)
    {
        if (!is_array($options) && !($options instanceof Traversable)) {
            require_once dirname(__FILE__) . '/Exception/InvalidArgumentException.php';
            throw new ZendW_Loader_Exception_InvalidArgumentException('Options must be either an array or Traversable');
        }
    ...
    public function registerNamespaces($namespaces)
    {
        if (!is_array($namespaces) && !$namespaces instanceof Traversable) {
            require_once dirname(__FILE__) . '/Exception/InvalidArgumentException.php';
            throw new ZendW_Loader_Exception_InvalidArgumentException('Namespace pairs must be either an array or Traversable');
        }
    ...
    public function registerPrefixes($prefixes)
    {
        if (!is_array($prefixes) && !$prefixes instanceof Traversable) {
            require_once dirname(__FILE__) . '/Exception/InvalidArgumentException.php';
            throw new ZendW_Loader_Exception_InvalidArgumentException('Prefix pairs must be either an array or Traversable');
        }
